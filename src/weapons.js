...
export const WEAPONS = {
  ...
  armorySniper01: {
    ...
    zoom: 34, scope: '4x', view: view(0.16, -0.05, -0.085, 0),
  ...
  armorySniper02: {
    ...
    zoom: 26, scope: '6x', view: view(0.165, -0.05, -0.09, 0),
  ...
  armorySniper03: {
    ...
    zoom: 32, scope: '5x', view: view(0.16, -0.04, -0.085, 0),
  ...
  armorySniper04: {
    ...
    zoom: 22, scope: '8x', view: view(0.175, -0.06, -0.095, 0),
